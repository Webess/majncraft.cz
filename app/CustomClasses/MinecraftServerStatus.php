...
class MinecraftServerStatus
{
    ...
    public function __construct($Host, $Port = 25565, $Timeout = 1)
    {
        ...
        if ($Players) {
            ...
            //     . "Host:majncraft.cz\r\n"
            //     ));
            // foreach ($player_arr as $name) {
            //     $player = file_get_contents("https://api.mojang.com/users/profiles/minecraft/$name");
            //     $player = json_decode($player);
            //     array_push($playerlist, $player);
            // }
            // $this->Info['players'] = $playerlist;
            $this->Info['players'] = $player_arr;
        }
